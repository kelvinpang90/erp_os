...
| 20 演示物料 | ✅ 完成 | 2026-05-11 | 2026-05-11 | ~50 | demo/ 一站式物料包：6 PPTX(5/15/30min × en/zh) + 2 one-pager PDF + 5 sample invoice PDF（覆盖 SST 10%/6%/0%/USD 多币种）+ 4 DOCX(FAQ × 2 + Proposal × 2，{{占位符}} 化) + 2 视频脚本 + recording guide(OBS 完整配置)+ 2 setlist(15/30min 现场便签含救场预案); 3 子 agent 并行（pptx/pdf/docx skills）+ 主线写脚本; node_modules 已 gitignore; 截图占位待演示前补 9 张 |
| 21 兜底演练 | ⏳ | | | | |
